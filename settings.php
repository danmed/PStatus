...
<table class="table table-striped" cellpadding="4" cellspacing="4" border="1">
	...
	<tr><Td><b>Enable Smart Devices</td><td><b>Default Refresh Rate</td><td><b>Directory Security - <img src="icons/medical.png" title="Required if you have password protected the directory that PStatus is running from. Without it, emails cannot be sent."></td></tr>
