...
<table cellpadding="4" cellspacing="4" border="1">
	<tr>
		<td><a href="serveradd.php">Admin</a></td><td><form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>"><select name="refresh" value="refresh"><option value="5">5</option><option value="10">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option><option value="30">30</option><input type="submit" value="Go"></form></td></tr></table><br>
