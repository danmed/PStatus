...
<table cellpadding="4" cellspacing="4" border="1">
	<tr>
		<td><a href="serveradd.php">Admin</a></td><td><select name="refresh" value="refresh" onchange="this.form.submit()"><option>refresh</option><option value="5">5</option><option value="10">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option><option value="30">30</option></td><td><?PHP echo now(); ?></td></tr></table></form><br>
