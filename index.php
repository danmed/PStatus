...
<table cellpadding="4" cellspacing="4" border="1">
	<tr>
		<td><a href="serveradd.php">Admin</a></td><td><form method="GET" action="<?php echo $_SERVER['PHP_SELF'];?>"><input type="text" name="refresh" value="<?PHP echo $refresh; ?>" size="2"><input type="submit" value="Go"></form></td></tr></table><br>
