...
<body class="wide comments example dt-example-bootstrap">
	...
	$('#example').DataTable();
						...
						<ul>
							...
							<li>
								<a href="https://cdn.datatables.net/1.10.15/js/dataTables.bootstrap.min.js">https://cdn.datatables.net/1.10.15/js/dataTables.bootstrap.min.js</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/responsive/2.1.1/js/dataTables.responsive.min.js">https://cdn.datatables.net/responsive/2.1.1/js/dataTables.responsive.min.js</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/responsive/2.1.1/js/responsive.bootstrap.min.js">https://cdn.datatables.net/responsive/2.1.1/js/responsive.bootstrap.min.js</a>
							</li>
						</ul>
					</div>
					<div class="table">
					...
					<div class="css">
						...
						<ul>
							...
							<li>
								<a href=
								"https://cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css">https://cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css</a>
							</li>
							<li>
								<a href=
								"https://cdn.datatables.net/responsive/2.1.1/css/responsive.bootstrap.min.css">https://cdn.datatables.net/responsive/2.1.1/css/responsive.bootstrap.min.css</a>
							</li>
						</ul>
					</div>
					<div class="ajax">
				...
				<div class="toc">
					...
					<div class="toc-group">
						...
						<ul class="toc active">
							...
							<li>
								<a href="./compact.html">Compact styling</a>
							</li>
							<li>
								<a href="./scrolling.html">Vertical scrolling</a>
							</li>
						</ul>
					</div>
				</div>
